    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Minha Loja Online</h1>
          <p className="text-slate-500 mt-1">Gerencie seu estoque e pedidos</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 px-8 py-6">
          ...
          <button
            ...
            disabled={loading}
            style={{ padding: '14px 16px' }}
            className="w-full rounded-lg border border-slate-200 text-slate-700 text-sm font-medium hover:bg-slate-50 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 mb-5"
          >
